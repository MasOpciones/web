// Instagram-only variant — 14 representative countries instead of 31.
// Keep in sync with GraficoConcentracionSalarial.jsx if data or style changes.
...
export default function GraficoConcentracionSalarialIG() {
    ...
    <section style={sectionStyle}>
      <div style={panelStyle} ref={wrapRef}>
        <svg
          ...
          height={svgH}
          role="img"
          aria-label="Dot plot comparativo de remuneraciones como porcentaje de costos de producción del gobierno, selección de países OCDE. Costa Rica 71.6% encabeza; Noruega 25.3% está al final."
      ...
      >
        <span>FUENTE: OCDE — Government at a Glance 2025</span>
